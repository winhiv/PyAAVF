...
class TestUtils(object):
    ...
    def test_walk(self):
        ...
        aavf1 = parser.Reader().parse_records(self.fhandle('sample.aavf'))
        aavf2 = parser.Reader().parse_records(self.fhandle('sample.aavf'))
        aavf3 = parser.Reader().parse_records(self.fhandle('sample.aavf'))
